...
- **[Basic Configuration](https://github.com/zeroflow/esphome-fancontroller/blob/main/examples/basic-rev-3.0.yaml)** - Minimal setup with 4 fans and essential features
