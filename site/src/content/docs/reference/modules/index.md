...
:::caution
You can only use **one** temperature control module at a time. The PID, Linear, and Curve modules all define the same internal `proxy_output` component. Importing more than one will cause an ESPHome compile error.
:::
